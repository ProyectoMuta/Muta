<?php
/**
 * Configuración de Mercado Pago - ARCHIVO DE EJEMPLO
 *
 * INSTRUCCIONES:
 * 1. Copia este archivo y renómbralo a "mp-config.php"
 * 2. Reemplaza las credenciales de ejemplo con tus credenciales reales
 * 3. NO compartas mp-config.php con tus credenciales reales
 *
